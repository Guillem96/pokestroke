...
#define POKEBALL_ANIM_THORW_FRAMES 12
#define POKEBALL_ANIM_OPENING_FRAMES 6
#define POKEBALL_ANIM_EXPLODING_FRAMES 6
#define POKEBALL_ANIM_CLOSING_FRAMES 6
#define POKEBALL_ANIM_BOUNCING_FRAMES 22
#define POKEBALL_ANIM_SHAKE_FRAME 4
#define POKEBALL_ANIM_BREAK_FEE_FRAMES 6

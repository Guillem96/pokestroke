...
#define PKMN_CAUGHT_INDIDATOR_OFFSET_X 346
#define PKMN_CAUGHT_INDIDATOR_OFFSET_Y 9

#define PKMN_NON_CAUGHT_INDIDATOR_OFFSET_X 360
#define PKMN_NON_CAUGHT_INDIDATOR_OFFSET_Y 57

#define PKMN_INDICATOR_SIZE 7

#define PKMN_NAME_OFFSET_X 12
...
void PkmnBattleSpriteSheeDrawCaughtIndicator(
    PkmnBattleSpriteSheet *sheet, unsigned short *isCaught, Vector2 pos, float scale);

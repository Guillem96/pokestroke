...
#define PKMN_SHINY_PROBABILITY 0.03f
#define PKMN_BW_PROBABILITY 0.01f
#define PKMN_CATCH_SUCCESS_PROBABILITY 0.15f

#define ULTRABALL_MULTIPLIER 1.75f
#define GREATBALL_MULTIPLIER 1.35f
...
#define GAME_MANAGER_STATE_THROWING_POKEBALL 1
#define GAME_MANAGER_STATE_REGISTERING_CATCH 2
